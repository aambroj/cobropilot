        ...
        <div className="mx-auto max-w-5xl space-y-6">
          <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <p className="mt-3 text-slate-600">
              Antes de eliminar facturas, carga los datos demo o crea el primer
              usuario.
            </p>
            <Link
              href="/facturas"
          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <p className="mt-3 max-w-3xl text-sm text-rose-50 md:text-base">
                Acción delicada. Si eliminas esta factura, también desaparecerán
                sus recordatorios asociados.
              </p>
            </div>
        ...
        <section className="grid gap-6 lg:grid-cols-[0.86fr_1.14fr]">
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm md:p-6">
              ...
              <div className="mt-4 rounded-2xl border border-rose-200 bg-rose-50 p-4">
                ...
                <p className="mt-2 text-sm leading-6 text-rose-700">
                  Si confirmas, la factura desaparecerá del panel y también se
                  borrarán los recordatorios asociados a este cobro.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm md:p-6">
            ...
            <p className="mt-1 text-sm text-slate-500">
              Para confirmar, escribe exactamente <span className="font-semibold">ELIMINAR FACTURA</span>.
            </p>
            ...
            <form action={deleteInvoice} className="mt-6 space-y-4">
              ...
              <div>
                ...
                <p className="mt-2 text-xs text-slate-500">
                  También puedes pulsar Enter después de escribir la confirmación.
                </p>
              </div>
